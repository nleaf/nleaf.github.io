...
(function ($) {
  $(document).ready(function() {
			...
			function updatevalues() {
				$( "#hdcapactity" ).val($( "#hdcapactity-slider" ).slider( "value" )+"GB");
				$( "#nobdrives" ).val($( "#nobdrives-slider" ).slider( "value" ));
				$( "#rperc" ).val($( "#rperc-slider" ).slider( "value" )+"%");
				$( "#wperc" ).val($( "#wperc-slider" ).slider( "value" )+"%");
				
				var hddtype = $("#hdtype").val();

				var D11 = $("#hdcapactity").val() + "-" + hddtype;
				var D12 = $("#nobdrives").val();
				var D13 = parseFloat($( "#rperc-slider" ).slider( "value" ))/100;
				var D14 = parseFloat($( "#wperc-slider" ).slider( "value" ))/100;
				
				var C16=(((((rounddown((((D12)/(2))),(0)))*(s2n(substitute((left((D11),(find3(("-"),(D11),(1))))),("GB-"),(""),(1))))))*(0.893)));
				$("#cell-c16").html( C16.formatMoney(0, '.', ',') + " GB");
				var C17=(((((D12)<(4)))?(0):((((D12)>(23)))?(((((((((((rounddown((((D12)/(24))),(0)))*(24)))*(s2n(substitute((left((D11),(find3(("-"),(D11),(1))))),("GB-"),(""),(1))))))*(((22)/(24)))))*(0.893)))+(((((mod((D12),(24)))>(3)))?(((((((mod((D12),(24)))-(2)))*(s2n(substitute((left((D11),(find3(("-"),(D11),(1))))),("GB-"),(""),(1))))))*(0.893))):(0))))):(((((((D12)-(2)))*(s2n(substitute((left((D11),(find3(("-"),(D11),(1))))),("GB-"),(""),(1))))))*(0.893))))));
				$("#cell-c17").html(C17.formatMoney(0, '.', ',') + " GB");
				var C18=(((((D12)<(3)))?(0):((((D12)>(9)))?(((((((((((rounddown((((D12)/(9))),(0)))*(9)))*(s2n(substitute((left((D11),(find3(("-"),(D11),(1))))),("GB-"),(""),(1))))))*(((8)/(9)))))*(0.893)))+(((((mod((D12),(9)))>(2)))?(((((((mod((D12),(9)))-(1)))*(s2n(substitute((left((D11),(find3(("-"),(D11),(1))))),("GB-"),(""),(1))))))*(0.893))):(0))))):(((((((D12)-(1)))*(s2n(substitute((left((D11),(find3(("-"),(D11),(1))))),("GB-"),(""),(1))))))*(0.893))))));
				$("#cell-c18").html(C18.formatMoney(0, '.', ',') + " GB");
				...
				$("#cell-e16").html(E16.formatMoney(0, '.', ','));
				var E17 = (((((C16)==(0)))?(0):((((
					(
						(hddtype=="SSD")?(10000):(
							(hddtype=="15K SAS")?(195):(
				...
				$("#cell-e17").html(E17.formatMoney(0, '.', ','));
				var E18 = (((((C16)==(0)))?(0):((((
					(
						(hddtype=="SSD")?(10000):(
							(hddtype=="15K SAS")?(195):(
				...
				$("#cell-e18").html(E18.formatMoney(0, '.', ','));
      ...
      $("#rperc").change(function() {
          rperc = $("#rperc-slider").slider("value");
					$("#wperc-slider").slider("value",(100-rperc));
					$("#wperc").val( (100-rperc) + "%");
      });
      $("#wperc").change(function() {
          wperc = $("#wperc-slider").slider("value");
					$("#rperc-slider").slider("value",(100-wperc));
					$("#rperc").val( (100-rperc) + "%");
      });      
      $(".calculator .field input").change(function() {
        updatevalues();
			...
			$( "#hdcapactity-slider" ).slider({
				range: "min",			
				value:superClean($( "#hdcapactity" ).val()),
				min: 80,
				max: 3072,
				step: 1,
				slide: function( event, ui ) {
					$( "#hdcapactity" ).val( ui.value + "GB");
			...
			$( "#nobdrives-slider" ).slider({
				range: "min",			
				value:superClean($( "#nobdrives" ).val()),
				min: 4,
				max: 240,
				step: 1,
				slide: function( event, ui ) {
					$( "#nobdrives" ).val( ui.value);
					clearTimeout(updateto);
					updateto=setTimeout(function(){updatevalues();},25);
				}
			});
			...
			$( "#rperc-slider" ).slider({
				range: "min",			
				value:superClean($("#rperc").val()),
				min: 10,
				max: 90,
				step: 1,
				slide: function( event, ui ) {
					$("#rperc").val( ui.value + "%");
					$("#wperc-slider").slider("value",(100-ui.value));
					$("#wperc").val( (100-ui.value) + "%");
					clearTimeout(updateto);
					updateto=setTimeout(function(){updatevalues();},25);
				}
			});
			...
			$( "#wperc-slider" ).slider({
				range: "min",			
				value:(100-$( "#rperc-slider" ).slider( "value" )),
				min: 10,
				max: 90,
				step: 1,
				slide: function( event, ui ) {
					$("#wperc").val( ui.value + "%");
					$("#rperc-slider").slider("value",(100-ui.value));
					$("#rperc").val( (100-ui.value) + "%");
					clearTimeout(updateto);
					updateto=setTimeout(function(){updatevalues();},25);
				}
			});
...
(function ($) {
  $(document).ready(function() {
    window.printpdf.print = function() {
      var title = "Print PDF | Disc RAID and IOPS Calculator";
      var data = "";
      ...
      data += window.printpdf.drawTable([
        ...
        [
          //Column 1
          [
            window.printpdf.printOption("#hdtype")
          ],
          //Column 2
          [
            " "
      ...
      data += window.printpdf.drawTable([
        ...
        [
          //Column 1
          [
            window.printpdf.printSlider("#hdcapactity")
          ],
          //Column 2
          [
            window.printpdf.printSlider("#rperc")
          ]  
        ],
        //Row 2
        [
          //Column 1
          [
            window.printpdf.printSlider("#nobdrives")
          ],
          //Column 2
          [
            window.printpdf.printSlider("#wperc")
          ]  
        ]
      //Name of Class in PDF output
      ], "#input-sliders");
      
      data += "<p class='disclaimer'>"+$(".disclaimer").html()+"</p>";
      // *******************************
      //          Results
      // *******************************
      ...
      data += "<h1>RESULTS:</h1>";
      data += "<div class='results raidiops'>";
      ...
      $("#table2 tr").each(function() {
        ...
        $(this).find("img").each(function() {
            $(this).attr("src", "http://" + document.domain + $(this).attr("src")).width(150);
        });        
