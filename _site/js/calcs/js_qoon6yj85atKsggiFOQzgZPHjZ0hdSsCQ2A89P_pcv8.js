...
(function ($) {
  $(document).ready(function() {
			...
			function updatevalues() {
				$( "#dataamount" ).val($( "#dataamount-slider" ).slider( "value" )+$("#sizeincrement").val());	
				$( "#transferreate" ).val($( "#transferreate-slider" ).slider( "value" )+" "+$("#bandwitdhrate").val());
				
				var C3=$( "#dataamount-slider" ).slider( "value" );
				var C4=$( "#transferreate-slider" ).slider("value");
				var D3 = $( "#sizeincrement" ).val();
				var D4 = $( "#bandwitdhrate" ).val();
				
				var B6=(((((((((((((((n2s(Math.floor((((((((v2n(((str_eq((D3),("KB")))?(8192):((str_eq((D3),("MB")))?(8388608):(((str_eq((D3),("GB")))?(8589934592):((str_eq((D3),("TB")))?(8796093022208):(""))))))))*(C3)))/(((v2n(((str_eq((D4),("Kbps")))?(1000):(((str_eq((D4),("Mbps")))?(1000000):((str_eq((D4),("Gbps")))?(1000000000):("")))))))*(C4)))))/(86400))))))+(" Days, ")))+(n2s(hour((((((((v2n(((str_eq((D3),("KB")))?(8192):((str_eq((D3),("MB")))?(8388608):(((str_eq((D3),("GB")))?(8589934592):((str_eq((D3),("TB")))?(8796093022208):(""))))))))*(C3)))/(((v2n(((str_eq((D4),("Kbps")))?(1000):(((str_eq((D4),("Mbps")))?(1000000):((str_eq((D4),("Gbps")))?(1000000000):("")))))))*(C4)))))/(86400))))))))+(" Hours, and ")))+(n2s(minute((((((((v2n(((str_eq((D3),("KB")))?(8192):((str_eq((D3),("MB")))?(8388608):(((str_eq((D3),("GB")))?(8589934592):((str_eq((D3),("TB")))?(8796093022208):(""))))))))*(C3)))/(((v2n(((str_eq((D4),("Kbps")))?(1000):(((str_eq((D4),("Mbps")))?(1000000):((str_eq((D4),("Gbps")))?(1000000000):("")))))))*(C4)))))/(86400))))))))+(" Minutes, ")))+(n2s(second((((((((v2n(((str_eq((D3),("KB")))?(8192):((str_eq((D3),("MB")))?(8388608):(((str_eq((D3),("GB")))?(8589934592):((str_eq((D3),("TB")))?(8796093022208):(""))))))))*(C3)))/(((v2n(((str_eq((D4),("Kbps")))?(1000):(((str_eq((D4),("Mbps")))?(1000000):((str_eq((D4),("Gbps")))?(1000000000):("")))))))*(C4)))))/(86400))))))))+(" Seconds")));
				
				$("#transfer-time span").html(B6);
			}
			/*********************************************************************************************************/
			/*										       SLIDERS	   											 */
			/*********************************************************************************************************/
      $(".calculator .field input").change(function() {
        updateto=setTimeout(function(){updatevalues();},25);
			...
			$( "#dataamount-slider" ).slider({
				range: "min",			
				value:superClean($( "#dataamount" ).val()),
				min: 1,
				max: 1024,
				step: 1,
				slide: function( event, ui ) {
					$( "#dataamount" ).val( ui.value + $("#sizeincrement").val());
			...
			$( "#transferreate-slider" ).slider({
				range: "min",			
				value:superClean($( "#transferreate" ).val()),
				min: 1,
				max: 1000,
				step: 1,
				slide: function( event, ui ) {
					$( "#transferreate" ).val( ui.value +" "+$("#bandwitdhrate").val());
					clearTimeout(updateto);
					updateto=setTimeout(function(){updatevalues();},25);
				}
			});
...
(function ($) {
  $(document).ready(function() {
    window.printpdf.print = function() {
      var title = "Print PDF | File Transfer Calculator";
      var data = "";
      ...
      data += window.printpdf.drawTable([
        ...
        [
          //Column 1
          [
            window.printpdf.printOption("#sizeincrement")
          ],
          //Column 2
          [
            window.printpdf.printOption("#bandwitdhrate")
          ]  
        ]
      ...
      data += window.printpdf.drawTable([
        ...
        [
          //Column 1
          [
            window.printpdf.printSlider("#dataamount")
          ],
          //Column 2
          [
            window.printpdf.printSlider("#transferreate")
          ]  
        ]
      //Name of Class in PDF output
      ], "#input-sliders");
      ...
      // *******************************
      data += "<h1>RESULTS:</h1>";
      data += "<div class='results filetransfer'>";
      data += $(".results").html();
      data += "</div>";
