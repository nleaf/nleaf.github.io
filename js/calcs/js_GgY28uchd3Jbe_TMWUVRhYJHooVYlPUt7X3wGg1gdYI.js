...
(function ($) {
  $(document).ready(function() {
			...
			function updatevalues() {
			  var datasizeincrement = $("#dsincrement").val();
			  $("span.dsinc").html(datasizeincrement);
			  			
				$( "#memconsumed" ).val($( "#memconsumed-slider" ).slider( "value")  + " GB");
				$( "#spacesonsumed" ).val($( "#spacesonsumed-slider" ).slider( "value")  + " "+datasizeincrement);
				$( "#hdwrcycle" ).val($( "#hdwrcycle-slider" ).slider( "value")  + " Year/s");
				$( "#numbcabs" ).val($( "#numbcabs-slider" ).slider( "value") + " Cabinets");
				$( "#costpercab" ).val("$" + $( "#costpercab-slider" ).slider( "value") + " /Mo");
                                
                                
				
			  if ($("#hdwloc").val() == "Internal Data Center") {
			      $("#costpercab-field").fadeOut(0);
			  }
			  else {
			      $("#costpercab-field").fadeIn(0);
			  }
			  //Constants
			  var C24 = 192;                //2 Socket Intel E5-2600 Server 
			  var C25 = 11862;              //Price + 3 year 4-Hour Maint
			  var C28 = 2;                  //vSphere Enterprise Plus Sockets
			  var C29 = (3495+874)*C28;     //Price + 3 Year Maint
			  var C32 = 40;                 //40 Port 10GbE Low Latency Switch
			  var C33 = 21611+3868;         //Price + 3 year 4-Hour Maint
			  var E24 = 13950;              //Dual Controller SAN, 24x900GB 10K
			  var E25 = 28890;              //Price + 3 year 4-Hour Maint
			  var E28 = .09;                //Cost Per kWh
			  var E29 = 2000;               //40RU Cabinet, With  PDUs
			  var E32 = 75000;              //Salary + Benefits
			  var D5 = $("#rlvl").val();	  
			  var D6 = $( "#memconsumed-slider" ).slider( "value");
			  var D7 = $( "#spacesonsumed-slider" ).slider( "value");
			  var D8 = $( "#hdwrcycle-slider" ).slider( "value");
			  var I5 = $("#hdwloc").val();
			  var I6 = $( "#numbcabs-slider" ).slider( "value");
			  var I7 = $( "#costpercab-slider" ).slider( "value");
			  //Calculations for Table 1
			  var D12 = roundup(D6/C24,0) + (D5 == 'High - N+2' ? 2 : 1);
			  var E12 = D12*(C25+C29);
			  var D13 = roundup(D7/E24,0);
			  var E13 = D13*E25;
			  var D14 = roundup(D12/15,0)*2;
			  var E14 = D14*C33;
			  var D15 = I6;
			  var E15 = D15*2000;
			  var D16 = (D12 + D13 + D14 + D15) *1.5*208;
			  var E16 = (I5 == "Internal Data Center" ? (D16*E28+I6*50*2)*12*D8 : (I7*I6*12*D8));
			  var D17 = roundup(((D12 + D13 + D14 + D15)-1)/3,0)*0.5;
			  var E17 = D17*E32*D8;
			  var total01 = E12 + E13 + E14 + E15 + E16 + E17;
        //Update HTML values for Table 1
        $("span#cell-d12").html(D12);
        $("span#cell-e12").html("$" + E12.formatMoney(0, '.', ','));
        $("span#cell-d13").html(D13);
        $("span#cell-e13").html("$" + E13.formatMoney(0, '.', ','));
        $("span#cell-d14").html(D14);
        $("span#cell-e14").html("$" + E14.formatMoney(0, '.', ','));
        $("span#cell-d15").html(D15);
        $("span#cell-e15").html("$" + E15.formatMoney(0, '.', ','));
        $("span#cell-d16").html(D16);
        $("span#cell-e16").html("$" + E16.formatMoney(0, '.', ','));
        $("span#cell-d17").html(D17);
        $("span#cell-e17").html("$" + E17.formatMoney(0, '.', ','));
        $(".hdw-yperiod").html(D8);
        $("#table1-total").val("$" + total01.formatMoney(0, '.', ','));
        			  
			  //Calculations for Table 2
			  var I12 = D6;
			  var J12 = (I12<100 ? I12*25 : (I12<200 ? I12*20 : (I12<500 ? I12*18 : I12*15)))*12*D8;
        //If TB is selected
        if (datasizeincrement == 'TB') {
          D7 = D7 * 1000;
        }			
          var I13 = D7;  
          var J13 = (I13<2000 ? I13*0.6 : 
                      (I13<4000 ? I13*0.5 : 
                          (I13<6000 ? I13*0.4 : 
                            (I13<8000 ? I13*0.35 : 
                              (I13<10000 ? I13*0.3 : 
                                (I13<15000 ? I13*0.25 : I13*0.2)
                  )))))*12*D8;

        var total02 = J12 + J13;
        
        $("span#cell-i12").html(I12);
        $("span#cell-j12").html("$" + J12.formatMoney(0, '.', ','));
        $("span#cell-i13").html(I13);
        $("span#cell-j13").html("$" + J13.formatMoney(0, '.', ','));
        $("span#cell-i14").html(0);
        $("span#cell-j14").html(0);
        $("span#cell-i15").html(0);
        $("span#cell-j15").html(0);
        $("span#cell-i16").html(0);
        $("span#cell-j16").html(0);
        $("span#cell-i17").html(0);
        $("span#cell-j17").html(0);
        $("#hdw-yperiod").html(D8);
        $("#table2-total").val("$" + total02.formatMoney(0, '.', ','));        
      ...
      $(".calculator .field input").change(function() {
        updateto=setTimeout(function(){updatevalues();},25);
      });
			...
			$( "#memconsumed-slider" ).slider({
				range: "min",			
				value:superClean($("#memconsumed").val()),
				min: 1,
				max: 2000,
				step: 1,
				slide: function( event, ui ) {
					$("#memconsumed").val( ui.value + " GB");
					clearTimeout(updateto);
					updateto=setTimeout(function(){updatevalues();},25);
				}
			});
			
			$( "#spacesonsumed-slider" ).slider({
				range: "min",			
				value:superClean($("#spacesonsumed").val()),
				min: 1,
				max: 1000,
				step: 1,
				slide: function( event, ui ) {
					$("#spacesonsumed").val( ui.value  + " "+datasizeincrement);
					clearTimeout(updateto);
					updateto=setTimeout(function(){updatevalues();},25);
				}
			});			
			
			$( "#hdwrcycle-slider" ).slider({
				range: "min",			
				value:superClean($("#hdwrcycle").val()),
				min: 1,
				max: 5,
				step: 1,
				slide: function( event, ui ) {
					$("#hdwrcycle").val( ui.value  + " Year/s");
					clearTimeout(updateto);
					updateto=setTimeout(function(){updatevalues();},25);
				}
			});
			
			$( "#numbcabs-slider" ).slider({
				range: "min",			
				value:superClean($("#numbcabs").val()),
				min: 1,
				max: 10,
				step: 1,
				slide: function( event, ui ) {
					$("#numbcabs").val( ui.value  + " Cabinets");
					clearTimeout(updateto);
					updateto=setTimeout(function(){updatevalues();},25);
				}
			});			
			
			$( "#costpercab-slider" ).slider({
				range: "min",			
				value:superClean($("#costpercab").val(),2),
				min: 1000,
				max: 5000,
				step: 100,
				slide: function( event, ui ) {
					$("#costpercab").val( "$" + ui.value  + "/Mo");
					clearTimeout(updateto);
					updateto=setTimeout(function(){updatevalues();},25);
				}
			});
...
(function ($) {
  $(document).ready(function() {
    window.printpdf.print = function() {
      var title = "Print PDF | Cloud Build vs Buy";
      var data = "";
      ...
      data += window.printpdf.drawTable([
        ...
        [
          //Column 1
          [
            window.printpdf.printOption("#rlvl")
          ],
          //Column 2
          [
            window.printpdf.printOption("#hdwloc")
          ]  
        ],
        //Row 2
        [
          //Column 1
          [
            window.printpdf.printOption("#dsincrement")
          ],
          //Column 2
          [
            " "
      ...
      data += window.printpdf.drawTable([
        ...
        [
          //Column 1
          [
            window.printpdf.printSlider("#memconsumed")
          ],
          //Column 2
          [
            window.printpdf.printSlider("#numbcabs")
          ]  
        ],
        //Row 2
        [
          //Column 1
          [
            window.printpdf.printSlider("#spacesonsumed")
          ],
          //Column 2
          [
            window.printpdf.printSlider("#costpercab")
          ]  
        ],
        //Row 3
        [
          //Column 1
          [
            window.printpdf.printSlider("#hdwrcycle")
          ],
          //Column 2
          [
            ""
      ...
      data += "<h1>The Total Cost Of Ownership To Build Your Own Cloud</h1>";
      data += "<table>";
      ...
      data += "</table>";
       data += "<div class='cloudwrap'>";
       data += "<h2 class='total'>"+$("#table1-total").val()+"</h2>";
       data += "</div>";
      
      rowiterator = 0;
      data += "<br/>";
      data += "<h1>The Total Cost Of Ownership Using A Hosted Cloud</h1>";
      data += "<table>";
      $("#table2 tr").each(function() {
       ...
       data += "</table>";
       data += "<div class='cloudwrap'>";
       data += "<h2 class='total'>"+$("#table2-total").val()+"</h2>";
       data += "</div>";
       //data += $('<div/>').append($("p.disclaimer").clone()).html();
      data += "</div>";
